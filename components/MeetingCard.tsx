  ...
  return (
    <div className="border border-gray-200 rounded-lg shadow-sm p-5 bg-white hover:shadow-md transition duration-200">
      <div className="flex justify-between items-center border-b pb-3 mb-3">
        <h2 className="text-lg font-bold text-gray-800">{meeting.date}</h2>
        <span className="bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded uppercase tracking-wider font-semibold">
          {meeting.meetingType}
        </span>
      </div>
      <div className="space-y-1 mb-4">
        <p className="text-sm text-gray-600"><strong className="text-gray-800">Chaired by:</strong> {meeting.presiding}</p>
        <p className="text-sm text-gray-600"><strong className="text-gray-800">Conducting:</strong> {meeting.conducting}</p>
      </div>
